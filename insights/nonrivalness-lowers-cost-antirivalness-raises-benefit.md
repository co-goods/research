---
title: Nonrivalness lowers the cost of sharing; antirivalness raises the benefits of sharing
slug: nonrivalness-lowers-cost-antirivalness-raises-benefit
type: insight
template_version: 1
category: theoretical
editor: pontus-karlsson
summary: Full inclusiveness requires addressing both dimensions - low-cost sharing AND high-benefit sharing. Neither quality alone is sufficient.
tags:
  - antirival
  - goods-theory
  - network-effects
...
key_findings:
  - Nonrivalness addresses the cost barrier to sharing (can it be shared without depletion?)
  - Antirivalness addresses the benefit dynamic of sharing (does sharing generate increasing returns?)
  - These operate independently - you can have one without the other
  - True inclusiveness requires BOTH low-cost and high-benefit sharing
implications:
...
research_questions:
  - What is the minimum cost threshold for effective sharing?
  - What is the minimum benefit threshold for sustained participation?
  - How do cost and benefit interact to create tipping points?
...
Physical products are inherently rival (high "sharing cost" for the object itself). The solution is to:
