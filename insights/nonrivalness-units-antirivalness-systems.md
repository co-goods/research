---
title: Nonrivalness is a property of units; antirivalness is a property of systems
slug: nonrivalness-units-antirivalness-systems
type: insight
template_version: 1
category: theoretical
editor: pontus-karlsson
summary: This unit-vs-system distinction explains why simply making something 'open' doesn't automatically create network effects. System architecture determines whether sharing generates increasing returns.
tags:
  - antirival
  - goods-theory
  - network-effects
...
whitepaper_section: theoretical-foundations
key_findings:
  - Nonrivalness is inherent to the good itself (can it be shared without loss?)
  - Antirivalness emerges from the system design (does sharing create increasing returns?)
  - The same nonrival good can be non-antirival or antirival depending on system design
  - Platform architecture is crucial for enabling antirival dynamics
implications:
...
research_questions:
  - What system design patterns consistently generate antirival dynamics?
  - Can we create antirival systems around inherently rival goods?
  - What is the minimum viable system for triggering anti-rivalry?
...
1. **Pre-Napster**: Files existed but sharing was fragmented, manual, limited
2. **Napster era**: Platform enabled discovery and collective library building
3. **Post-Napster**: Various platforms (Spotify, etc.) with different architectures creating different dynamics
...
**Design principle:**
Focus less on making units nonrival (impossible for physical goods), and more on designing systems where:
