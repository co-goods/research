---
title: Antirivalness is orthogonal to nonrivalness
slug: antirivalness-orthogonal-to-nonrivalness
type: insight
template_version: 1
category: theoretical
editor: pontus-karlsson
summary: Antirivalness and nonrivalness are two separate dimensions, not stages on a continuum. This distinction is crucial for understanding how collective goods create value.
tags:
  - antirival
  - goods-theory
  - network-effects
...
key_findings:
  - Nonrivalness describes whether sharing depletes the good itself
  - Antirivalness describes whether the system of sharing generates increasing returns
  - A good can be nonrival without being antirival (e.g., a static PDF)
  - Some antirival systems contain rival components (e.g., traffic light networks)
implications:
...
research_questions:
  - How do we measure the degree of antirivalness in a system?
  - What design patterns maximize both nonrivalness and antirivalness?
