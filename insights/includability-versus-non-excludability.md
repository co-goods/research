---
title: Collective goods require high includability, not merely non-excludability
slug: includability-versus-non-excludability
type: insight
template_version: 1
category: theoretical
editor: pontus-karlsson
summary: Non-excludability means access cannot be prevented. Includability means the system actively welcomes and rewards participation. True collective goods require the latter.
tags:
  - antirival
  - commons
  - goods-theory
...
key_findings:
  - Non-excludability is passive (access cannot be prevented)
  - Includability is active (system designed for participation)
  - Wikipedia is both non-excludable and highly inclusive through contribution mechanisms
  - Radio broadcasts are non-excludable but not particularly inclusive
implications:
...
research_questions:
  - What design patterns maximize includability?
  - How do we balance openness with quality control?
  - What is the relationship between includability and sustainability?
